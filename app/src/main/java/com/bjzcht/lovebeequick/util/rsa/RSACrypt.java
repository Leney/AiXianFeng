package com.bjzcht.lovebeequick.util.rsa;
...
//		}
		...
		String encoding = base64Encoder.encode(encryptedData).toString();
		out.close();
		return encoding;
	}
...
//		byte[] encryptedData = out.toByteArray();
//		out.close();
//		return new BASE64Encoder().encode(encryptedData).toString();
//	}
