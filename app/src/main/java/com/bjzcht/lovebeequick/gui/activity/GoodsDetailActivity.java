...
import com.bjzcht.lovebeequick.gui.adapter.DetailBannerAdapter;
import com.bjzcht.lovebeequick.gui.fragment.CommentFragment;
import com.bjzcht.lovebeequick.gui.view.CenterLineTextView;
import com.bjzcht.lovebeequick.gui.view.RollPagerViewLab;
import com.bjzcht.lovebeequick.gui.view.SelfAdaptionViewGroup;
import com.bjzcht.lovebeequick.gui.view.WraperScrollView;
        ...
        switch (view.getId()) {
            ...
            case R.id.goods_detail_add_btn:
                ...
                if (curNum2 >= goodsDetail.getStock()) {
                    ...
                    Util.showToast(GoodsDetailActivity.this,"商品库存不足了喔！");
                    return;
                }
