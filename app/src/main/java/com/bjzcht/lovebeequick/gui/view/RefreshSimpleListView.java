 ...
 */
public class RefreshSimpleListView extends WraperListView implements AbsListView.OnScrollListener {
    ...
    public RefreshSimpleListView(Context context) {
        super(context);
        init(context);
    }

    public RefreshSimpleListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public RefreshSimpleListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public RefreshSimpleListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        ...
        headView = (LinearLayout) inflater.inflate(R.layout.head_simple, null);
