...
import com.bjzcht.lovebeequick.net.NetErrorHelper;
...
public abstract class BaseFragment extends Fragment {
    ...
    Bundle savedInstanceState) {
        RelativeLayout baseView = (RelativeLayout) inflater.inflate(R.layout.fragment_base,
                container, false);
        centerLay = (RelativeLayout) baseView.findViewById(R.id.base_fragment_center);
        loadingView = (TextView) baseView.findViewById(R.id.base_fragment_loading);
        errorView = (TextView) baseView.findViewById(R.id.base_fragment_error);
        ...
        childAddLay = (RelativeLayout) baseView.findViewById(R.id.base_fragment_add_lay);
        noDataView = (RelativeLayout) baseView.findViewById(R.id.base_fragment_no_data);
    ...
    protected void setAddView(int layoutId) {
        setAddView(View.inflate(getActivity(), layoutId, null));
    }
    ...
    protected void addNoDataView(int layoutId) {
        addNoDataView(View.inflate(getActivity(), layoutId, null));
    }
...
//     * @return
//     */
//    private JSONObject parseBaseData(String result, int code){
//        try {
...
//                // 获取数据成功
//                // 返回需要解析的JsonObject对象
//                return resultObject.getJSONObject("map");
//            }
//        } catch (Exception e) {
